...
public class ItemTemplates {
    ...
    public static final ItemTemplate RIFLE_MANNLICHER_95 = new ItemTemplate("Mannlicher 95 [Rifle]", ITEMS_PATH + "Mannlicher95/mannlicher95.j3o", ICON_PATH + "equipmentMannlicher95.png", ITEMS_PATH + "Mannlicher95/Mannlicher95Drop.j3o", new DropOffsetData(new Vector3f(0, 0.05f, 0), new Vector3f(0, 0, 90 * FastMath.DEG_TO_RAD), 1.2f), ItemType.RIFLE, 0);
    ...
    public static final ItemTemplate KNIFE = new ItemTemplate("Trench Knife [Melee]", ITEMS_PATH + "trenchKnife/trenchKnife.j3o", ICON_PATH + "equipmentTrenchKnife.png", ITEMS_PATH + "trenchKnife/trenchKnifeDrop.j3o", new DropOffsetData(new Vector3f(0, 0.05f, 0), new Vector3f(90 * FastMath.DEG_TO_RAD, 0, 90 * FastMath.DEG_TO_RAD), 1), ItemType.KNIFE, 4);
    ...
    public static final ItemTemplate PISTOL_C96 = new ItemTemplate("C96 [Pistol]", ITEMS_PATH + "C96/c96.j3o", ICON_PATH + "equipmentC96.png", ITEMS_PATH + "C96/c96drop.j3o", new DropOffsetData(new Vector3f(0, 0.05f, 0), new Vector3f(0, 0, 90 * FastMath.DEG_TO_RAD), 1.2f), ItemType.PISTOL, 9);
    ...
    public static final ItemTemplate RIFLE_AMMO_PACK = new ItemTemplate("Rifle Ammo Pack [Ammo]", null, ICON_PATH + "equipmentSmokeGrenade.png", ITEMS_PATH + "AmmoPacks/pistolAmmoPack.j3o", new DropOffsetData(new Vector3f(0, 0.05f, 0), new Vector3f(0, 0, 0 * FastMath.DEG_TO_RAD), 1.1f), ItemType.RIFLE_AMMO, 12);
    ...
    public static final ItemTemplate SNIPER_AMMO_PACK = new ItemTemplate("Sniper Ammo Pack [Ammo]", null, ICON_PATH + "equipmentSmokeGrenade.png", ITEMS_PATH + "AmmoPacks/pistolAmmoPack.j3o", new DropOffsetData(new Vector3f(0, 0.05f, 0), new Vector3f(0, 0, 0 * FastMath.DEG_TO_RAD), 1.1f), ItemType.SNIPER_AMMO, 14);
    ...
    static {
        ...
        templates.add(SNIPER_AMMO_PACK.getTemplateIndex(), SNIPER_AMMO_PACK);
    ...
    public enum ItemType {
        ...
        RIFLE, PISTOL, KNIFE, GRENADE,
        PISTOL_AMMO, RIFLE_AMMO, SMG_AMMO, SNIPER_AMMO, SHOTGUN_AMMO
    }
